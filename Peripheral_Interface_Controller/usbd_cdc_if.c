...
static int8_t Peripheral_Interface_Controller_Init     (void);
static int8_t Peripheral_Interface_Controller_DeInit   (void);
static int8_t Peripheral_Interface_Controller_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t Peripheral_Interface_Controller_Receive  (uint8_t* pbuf, uint32_t *Len);

USBD_CDC_ItfTypeDef USBD_CDC_Peripheral_Interface_Controller_fops = 
{
  Peripheral_Interface_Controller_Init,
  Peripheral_Interface_Controller_DeInit,
  Peripheral_Interface_Controller_Control,
  Peripheral_Interface_Controller_Receive
};
...
/**
  * @brief  Peripheral_Interface_Controller_Init
...
/**
  * @brief  Peripheral_Interface_Controller_DeInit
...
/**
  * @brief  Peripheral_Interface_Controller_Control
...
/**
  * @brief  Peripheral_Interface_Controller_Receive
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t Peripheral_Interface_Controller_Receive(uint8_t* Buf, uint32_t *Len)
{
